...
def setup(level):
    ...
    number_count=min(number_count,20) # 만약 20을 초과하면 20 으로 처리
...
def shuffle_grid(number_count):
    ...
    number=1 # 시작 숫자를 1 부터 number_count 까지, 만약 5 라면 5까지 숫자를 랜덤으로 배치하기
...
def check_number_buttons(pos):
    ...
    # 모든 숫자를 다 맞췄다면? 레벨을 높여서 다시 시작 화면으로 감
...
# 게임 시작 여부
start=False
# 숫자 숨김 여부 (사용자가 1을 클릭했거나, 보여주는 시간 초과했을때)
hidden=False
